const es = {
  ...
  // promos / buttons
  promo_text: "¡La mejor oferta de hoy! ¡COMPRA AHORA!",
  order_whatsapp: "Pedir por WhatsApp",
  read_more: "Leer más",
  read_less: "Leer menos",

  // sections
  feature_collection: "COLECCIÓN DESTACADA",
  feature_subtitle: "Selección curada: líneas limpias y comodidad diaria.",
  ...
  no_results:
    "Sin resultados. Intenta con otras palabras (p. ej., “aviador”, “luz azul”).",
  ...
  // FOOTER — add/match these keys to your Footer.js
  footer_tagline: "Moda óptica atemporal y cuidado profesional de la vista.",
  footer_shop: "Tienda",
  footer_care: "Atención al cliente",

  // footer shop links
  shop_mens: "Gafas para hombre",
  shop_womens: "Gafas para mujer",
  shop_kids: "Gafas para niños",
  shop_sunglasses: "Gafas de sol",
  shop_bluelight: "Gafas de luz azul",
  shop_contacts: "Lentes de contacto",

  // footer care links
  care_shipping: "Envíos y entregas",
  care_returns: "Devoluciones y cambios",
  care_warranty: "Garantía",
  care_faq: "Preguntas frecuentes",
  care_exam: "Agendar examen visual",
  care_contact: "Contáctanos",

  // footer newsletter + contact
  stay_in_loop: "Mantente al día",
  subscribe: "Suscribirse",
  newsletter_blurb:
    "Recibe lanzamientos, ofertas y consejos de cuidado visual. Sin spam: puedes darte de baja cuando quieras.",
  newsletter_placeholder: "tú@ejemplo.com",
  call_us: "Llámanos",
  email: "Correo",
  visit: "Visítanos",
  address_line: "Av. Óptica 123, Local 2, Ciudad Visión",
  hours: "Horario",
  hours_val: "Lun–Sáb 9:00–18:00",
